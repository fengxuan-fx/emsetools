...
function sendEmailLicsIssuedNotice(capID) {
    var wFlowTask = "License Issuance";                           // wflowTask
    var wfStatus = "Issued"; //Generate Letter for Underpayment, No Payment, Additional Information Needed";                          // wflowStatus
    var sendEmailToContactType = "Business"; //Applicant";
    var FromEmailAddress = "noreply@agriculture.ny.gov";
    var toEmailAddress = "";

    var tmplName = "LICENSE ISSUED";
	//logDebug("Inside sendEmailLicsIssuedNotice");
