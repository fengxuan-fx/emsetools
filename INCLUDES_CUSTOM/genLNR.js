function genLNR() {
    var wFlowTask = "Inspection";                           // wflowTask
    var wfStatus = "License Not Required"; //Generate Letter for Underpayment, No Payment, Additional Information Needed";                          // wflowStatus
    var sendEmailToContactType = "Business"; //Applicant";
    var FromEmailAddress = "noreply@agriculture.ny.gov";
    var toEmailAddress = "";

   var tmplName = "LICENSE NOT REQUIRED";
