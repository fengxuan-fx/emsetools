function addToSet(recordType, parentID,typeOfSet)
{
   ...
   for(var i=0;;i++)
   {
		...
		{
			id = recordType + "_" + "Inspection" + "_" + tDate + "_" + (i+1); 
		}
		else if(recordType=="Establishment" && arguments.length==3)
		{
			if(typeOfSet=="Quarantine")
			{
				id="Violation of Quarantine Letter" + "_" + tDate + "_" + (i+1);
			}
			if(typeOfSet=="Stop Sale")
			{
				id="Violation of Stop Sale Letter" + "_" + tDate + "_" + (i+1);
			}
			if(typeOfSet=="Plum Pox")
			{
				id="Plum Pox Compliance Agreement Interview" + "_" + tDate + "_" + (i+1);
			}
			if(typeOfSet=="Emerald Ash")
			{
				id="Emerald Ash Borer Compliance Agreement Interview" + "_" + tDate + "_" + (i+1);
			}
		}
		else
		{
	...
	else if(recordType=="Establishment" && arguments.length==3)
	{
		...
		else if(typeOfSet=="Plum Pox")
		{
			setDescription="Plum Pox Compliance Agreement Issued";
		}
		else if(typeOfSet=="Emerald Ash")
		{
			setDescription="Emerald Ash Compliance Agreement Issued";
		}
	}
	else
	{
    ...
    else if(setIDForCompleted)
    {
		...
		if(recordType=="Establishment" && arguments.length==2)
		{
			tempStr=recordType + "_" + "Inspection" + "_" + tDate + "_";
		}
		else if(recordType=="Establishment" && arguments.length==3)
		{
			if(typeOfSet=="Quarantine")
			{
				tempStr="Violation of Quarantine Letter" + "_" + tDate + "_";
			}
			else
			{
				tempStr="Violation of Stop Sale Letter" + "_" + tDate + "_";
			}
		}
		else
		{
			tempStr=recordType + "_" + tDate + "_";
		}
		...
		if(recordType=="Establishment" && arguments.length==2)
		{
			newSetId= recordType + "_" + "Inspection" + "_" + tDate + "_" + setNumber;
		}
		else if(recordType=="Establishment" && arguments.length==3)
		{
			if(typeOfSet=="Quarantine")
			{
				newSetId= "Violation of Quarantine Letter" + "_" + tDate + "_" + setNumber;
			}
			else
			{
				newSetId= "Violation of Stop Sale Letter" + "_" + tDate + "_" + setNumber;
			}
		}
		else
		{
			newSetId= recordType + "_" + tDate + "_" + setNumber;
		}
