	...
	if(flag==1)
	{
		...
		for(j=0;j<array.size();j++)
		{
			...
			if (inspResultObj.getSuccess())
			{
				...
				for (xx in inspList)
				{
					if((inspList[xx].getInspectionType().equalsIgnoreCase("Plum Pox Compliance Agreement Interview") || inspList[xx].getInspectionType().equalsIgnoreCase("Emerald Ash Borer Compliance Agreement Interview"))&& inspList[xx].getInspectionStatus().equalsIgnoreCase("Issued"))
					{
