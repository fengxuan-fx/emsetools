...
try {
	...
	if (theContact) {
		...
		if (appMatch("Licenses/Amendment/NA/Name Change") || appMatch("Licenses/Amendment/NA/Contact Info Change")) {
			editAppSpecific4ACA("Contact Type Flag",theContact.people.getContactTypeFlag());
