/*------------------------------------------------------------------------------------------------------/
| Program : ACA Fert Tonnage Total.js
...
if(parseFloat(totalAmt) == 0)
	...
	{
		tonnageFee =  parseFloat(totalAmt)*.10;
	}	
	
editAppSpecific4ACA("January - December Total Tons",totalAmt);
editAppSpecific4ACA("Total Tons x $.10/Ton =",tonnageFee);
