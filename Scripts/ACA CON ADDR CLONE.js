...
try {
 ...
 var checkForBusContact = false;
	...
	if(pId)
	{
		...
		//cancel = true;
		//showMessage = true;
		//message =  "Parent Id: " + pId + " License details: " + fnameForLicense + " " + lnameForLicense + " " + businessNameForLicense;
		//message = "Parent Id: " + pId + " License details: " + fnameForLicense + " " + lnameForLicense + " " + businessNameForLicense + " Renewal details: " + fnameForRenewal + " " + lnameForRenewal + " " + businessNameForRenewal;
		
		if((fnameForLicense != null && fnameForLicense != '' && fnameForRenewal != null && fnameForRenewal != '' ) && (lnameForLicense != null && lnameForLicense != '' && lnameForRenewal != null && lnameForRenewal != ''))
		{
			if(!(fnameForLicense.equalsIgnoreCase(fnameForRenewal)) || !(lnameForLicense.equalsIgnoreCase(lnameForRenewal)))
			{
				checkForBusContact = true;
			}
		}
		else if(((fnameForLicense != null && fnameForLicense != '')  && (fnameForRenewal == null && fnameForRenewal == '')) || ((fnameForLicense == null && fnameForLicense == '') && (fnameForRenewal != null && fnameForRenewal != '')) || ((lnameForLicense != null && lnameForLicense != '') && (lnameForRenewal == null && lnameForRenewal == '')) || ((lnameForLicense == null && lnameForLicense == '') && (lnameForRenewal != null && lnameForRenewal != '')))
		{
			checkForBusContact = true;
		}
	...
	if (showError || checkForBusContact)
	{
		cancel = true;
		showMessage = true;
		if(showError && !checkForBusContact)
		...
		else if(checkForBusContact && !showError)
		{
			message = "<br>Business contact cannot be modified<br>";
		}
		else if(showError && checkForBusContact)
		{
			message = "<div class='addressList'>" + contactAddrMessage + addrListMessage + "</ul></div>" + "<br>" + "Business contact cannot be modified";
		}
	}	
