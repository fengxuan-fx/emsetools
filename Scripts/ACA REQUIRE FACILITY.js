...
/-----------------------------------------------------------------------------------------------------*/
 ...
 var conModel = getContactByType4ACA("Facility Location"); 
  if(AInfo['Do you have any facilities in New York?'] == "Yes"){
	if(!conModel){
	showMessage = true; 
		cancel = true; 
		//comment("-------------------------------------------------");
		comment("You answered Yes to having facilities in New York, you must enter at least 1 facility location below");
	}
	
	//else{
	//showMessage = true;
	//cancel = true;
	//comment("No Facility Needed");
	//}
