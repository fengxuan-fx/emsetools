...
try {
 ...
 if (displayError && checkForBusContact) 
 {
  cancel = true;
  showMessage = true;
  message = "<br>Business contact cannot be modified<br>";
  //message = "Cap Id: " + capId + " Parent Id: " + pId + " Fname: " + fnameForLicense + " Lname: " + lnameForLicense + " Business Name: " + businessNameForLicense + "<br>" + "Renewal name: " +  fnameForRenewal + " " +lnameForRenewal + " " + businessNameForRenewal;
 }
 checkForBusContact = false;
